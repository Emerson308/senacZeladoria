...
type NotificationCardProps = {onNotificationRead: (id: number) => void} & Notification

export default function NotificationCard({mensagem, lida, link, id, data_criacao, onNotificationRead}: NotificationCardProps){
    return (
